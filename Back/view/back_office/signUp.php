        ...
        <div class="col-md-4 offset-md-4">
            ...
            <div class="card wow fadeIn" data-wow-delay="0.3s">
                <div class="card-body" style="background:#fff;">
                    ...
                    <!--Corps formulaire-->
                    <div class="p-2">
                        <form class="custom-card-form" method="POST" action="../../controller/StaffController.php">
                            <?php
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="" name="login" id="inputEmail" class="form-control" required="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="text-center btn-custom">
                                <button type="submit" class="btn btn-lg" name="inscript">S'inscrire</button>
                            </div>
